...
object ExerciseDBMapper {
    ...
    fun toExerciseEntity(exerciseDB: ExerciseDBExercise): ExerciseEntity {
        return ExerciseEntity(
            ...
            instructionsSteps = gson.toJson(exerciseDB.instructions ?: emptyList<String>()),
            commonMistakes = gson.toJson(exerciseDB.exerciseTips?.take(3) ?: emptyList<String>()),
            safetyTips = gson.toJson(exerciseDB.exerciseTips?.drop(3) ?: emptyList<String>()),
